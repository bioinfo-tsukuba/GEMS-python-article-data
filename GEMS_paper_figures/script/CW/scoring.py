...
if __name__ == "__main__":
    path = Path("data/gems_ot2_colour-water-optimisation/result/step_00000016/experiments/gen_ot2_cwo_experiment_aa9a0574-ca55-4813-9d25-2a66161e4afd_shared_variable_history.csv")
    df = pl.read_csv(path)
    ...
    output_path = Path("artifacts/CW/scored.csv")
